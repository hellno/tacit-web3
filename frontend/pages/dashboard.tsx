                    ...
                    <div className="md:col-span-1">
                      <div className="px-4 sm:px-0">
                        <h3 className="text-lg font-medium leading-6 text-gray-900">
                          Create new reward plan
                        </h3>
                        <p className="mt-1 text-sm text-gray-600">
                          Tacit offers templates for the most impactful reward systems.
                        </p>
                      </div>
                    </div>
                          ...
                          <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                            <div className="grid grid-cols-3 gap-6">
                              ...
                              <div className="col-span-3 sm:col-span-2">
                                ...
                                {/* </div> */}
                                <FormCombobox
                                  items={[{ name: 'Referral' }, { name: 'Loyalty Program' }, { name: 'Leaderboard' }, { name: 'Quest' }]} />
                              </div>
  ...
  return (
    <>
      ...
      */}
      ...
      <DashboardModal open={modalOpen} setOpen={setModalOpen} />
